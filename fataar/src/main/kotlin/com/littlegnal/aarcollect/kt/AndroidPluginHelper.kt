...
fun getAndroidPluginVersion(): String {
  return Reflect.on("com.android.builder.Version")
...
fun resolveBundleDir(
  ...
  return if (VersionNumber.parse(getAndroidPluginVersion()) < VersionNumber.parse("2.3.0")) {
    ...
    val mergeAssetsTask = Reflect.on(variant)
        .call("getMergeAssets")
        .get<Task>()
    val assetsDir: File = Reflect.on(mergeAssetsTask)
        .call("getOutputDir")
        .get<File>()
