package com.littlegnal.aarcollect.kt
...
fun processIntoJars(
  project: Project,
  androidLibraries: List<AndroidArchiveLibrary>,
  jarFiles: List<File>,
  folderOut: File
) {
  for (androidLibrary in androidLibraries) {
    ...
    project.copy { copySpec ->
      ...
      aarLog(
          "!!!!!!!!!!  copy    ${androidLibrary.getClassesJarFile()} && ${androidLibrary.getClassesJarFile
          ().exists()}"
      )
    }
    ...
    project.copy { copySpec ->
      ...
      aarLog(
          "!!!!!!!!!!  copy    ${androidLibrary.getLocalJars()} && ${androidLibrary.getLocalJars().size}"
      )
    }
  }
